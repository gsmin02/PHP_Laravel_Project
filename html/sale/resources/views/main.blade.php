...
<head>
  ...
  <title>판매관리</title>
	...
	<link href="https://fonts.googleapis.com/css2?family=Spoqa+Han+Sans&display=swap" rel="stylesheet">
...
<div class="container">
	<div class="navbar navbar-expand-lg navbar-dark my-bg-1 mb-4 rounded-bottom">
		<div class="container-fluid">
			<a class="navbar-brand" href="{{ url('/') }}">판매관리</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="{{ route('worker.index') }}">Worker</a></li>
					<li class="nav-item"><a class="nav-link" href="{{ route('co.index') }}">Test</a></li>
				</ul>
				@if(!session()->exists("uid"))
					<a href="#" class="btn btn-sm btn-outline-light my-btn-bg-1" data-bs-toggle='modal' data-bs-target='#exampleModal'>로그인</a>
				@else
					<a href="{{ url('login/logout') }}" class="btn btn-sm btn-outline-light my-btn-bg-1">로그아웃</a>
				@endif
			</div>
		</div>
	</div>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
	  ...
	  <div class="carousel-inner rounded">
		<div class="carousel-item active">
		  <img src="{{ asset('/my/img/main_banner_1.jpg') }}" height="300" class="d-block w-100">
		</div>
		<div class="carousel-item rounded">
		  <img src="{{ asset('/my/img/main_banner_2.jpg') }}" height="300" class="d-block w-100">
		</div>
		<div class="carousel-item rounded">
		  <img src="{{ asset('/my/img/main_banner_3.jpg') }}" height="300" class="d-block w-100">
		</div>
		<div class="carousel-item rounded">
		  <img src="{{ asset('/my/img/main_banner_4.jpg') }}" height="300" class="d-block w-100">
		</div>
		<div class="carousel-item rounded">
		  <img src="{{ asset('/my/img/main_banner_5.jpg') }}" height="300" class="d-block w-100">
		</div>
	  </div>
