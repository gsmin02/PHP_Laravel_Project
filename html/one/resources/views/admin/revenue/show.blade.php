			...
			<form name="form1" method="post" action="">
				<div class="bg-light rounded h-100 p-4">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">{{ number_format($row->out_num) }}</div>
					</div>
					<div class="row mb-3">
					...
					<div align="center">
						<a href="{{ route( 'revenue.edit', $row->id ) }}{{ $tmp }}" class="btn btn-primary">Edit</a>
						<form action="{{ route( 'revenue.destroy', $row->id ) }}" style="display: inline-block;">
						@csrf
						@method('DELETE')
