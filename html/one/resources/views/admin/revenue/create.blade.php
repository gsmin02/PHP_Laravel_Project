...
<script>
	...
	function select_product()
	{
		...
		else
		{
			...
			form1.total_price.value = Number(form1.unit_price.value) * Number(form1.out_num.value);
		}
	}
	...
	<div class="row g-4">	
		<div class="col-sm-12 col-xl-12">
			<div class="bg-light rounded h-100 p-4">
				<h6 class="mb-4">Revenue Create</h6>
				<form name="form1" method="post" action="{{ route('revenue.store') }}{{ $tmp }}">
				@csrf
					<div class="row mb-3">
					...
					<div class="row mb-3">
						<label for="inputName" class="col-sm-2 col-form-label">Revenue date</label>
						<div class="col-sm-10">
							<input type="text" name="trade_date" size="20" value="{{ old('trade_date') }}" class="form-control" placeholder="YYYY-MM-DD">
							<!--
						...
						<div class="col-sm-10">
							...
							<select name="product_name" class="form-select mb-3" id="inputProduct_name" onChange="select_product()">
								...
								@foreach ($list_product as $row_product)
									...
									?>
									@if ($row_product->id == old('product_name'))
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputUnitPrice" name="unit_price" size="11" maxlength="11" value="{{ old('unit_price') }}" onChange="cal_prices()">
						</div>
					</div>
					<div class="row mb-3">
						<label for="inputAmount" class="col-sm-2 col-form-label">Amount</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputAmount" name="out_num" size="11" maxlength="11" value="{{ old('out_num') }}" onChange="cal_prices()">
						</div>
					</div>
					<div class="row mb-3">
						<label for="inputTotalPrice" class="col-sm-2 col-form-label">Total Price</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputTotalPrice" name="total_price" size="11" maxlength="11" value="{{ old('total_price') }}">
						</div>
					</div>
					<div class="row mb-3">
						<label for="inputMemo" class="col-sm-2 col-form-label">Memo</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputMemo" name="memo" size="100" maxlength="100" value="{{ old('memo') }}">
						</div>
					</div>
					<div align="center">
