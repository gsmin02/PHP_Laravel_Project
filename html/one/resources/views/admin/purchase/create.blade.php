	...
	<div class="row g-4">	
		<div class="col-sm-12 col-xl-12">
			<div class="bg-light rounded h-100 p-4">
				<h6 class="mb-4">Purchase Create</h6>
				<form name="form1" method="post" action="{{ route('purchase.store') }}{{ $tmp }}">
				@csrf
					<div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputAmount" name="in_num" size="11" maxlength="11" value="{{ old('in_num') }}" onChange="cal_prices()">
						</div>
					</div>
					<div class="row mb-3">
